bind! {
    ...
    php_register_variable_safe, php_output_deactivate, rapira_current_mode, rapira_set_mode, RAPIRA_MODE_CLASSIC, RAPIRA_MODE_WORKER,
    ...
    rapira_grpc_call_obj, rapira_grpc_metadata_obj, rapira_grpc_build, rapira_enum_case,
    rapira_grpc_message_alloc, rapira_grpc_message_share, rapira_grpc_message_release,
    rapira_ce_grpc_status_code, rapira_ce_grpc_method_kind, rapira_ce_grpc_error_detail,
    rapira_ce_grpc_status, rapira_ce_grpc_method_info, rapira_ce_grpc_service_info,
    rapira_ce_grpc_exception, rapira_ce_grpc_metadata, rapira_array_iterator,
    rapira_ce_grpc_context, rapira_ce_grpc_protocol, rapira_ce_internal_grpc_dispatcher,
    rapira_ce_internal_grpc_dispatcher_info, rapira_ce_internal_grpc_call,
